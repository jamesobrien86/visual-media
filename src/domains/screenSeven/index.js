...
export default function ScreenSeven(props){
    return(
            ...
            <Container>
               <Grid container direction="row">
                   <Grid item sm={8}>
                       <Grid container direction="row">
                           <Grid item sm={12}>
                                <IframeBlock height="60" title={iframeOne.title} desc={iframeOne.desc} url={iframeOne.iframe} /> 
                           </Grid>
                           <Grid item sm={12}>
                                <IframeBlock  height="40"  title={iframeOne.title} desc={iframeOne.desc} url={iframeOne.iframe} /> 
                           </Grid>
                       </Grid>
                   </Grid>
                   <Grid item sm={4}>
